...
class TestDocumentSystem(unittest.TestCase):
    def test_document_creation(self):
        # Teste la création d'un document Reddit avec un nombre de commentaires
        ...
        # Teste la création d'un document Arxiv avec une liste d'auteurs
    ...
    def test_corpus_polymorphism(self):
        # Teste l'ajout de documents Reddit et Arxiv à un corpus
    ...
    def test_document_str(self):
        # Teste la méthode __str__ pour s'assurer qu'elle renvoie la chaîne attendue pour chaque type de document
        reddit_doc = RedditDocument("Reddit Test", "Author1", "2023-03-14", "http://reddit.com", "Text", 10)
        arxiv_doc = ArxivDocument("Arxiv Test", ["Author2"], "2023-02-14", "http://arxiv.org", "Text")
